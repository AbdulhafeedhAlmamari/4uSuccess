...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="card p-4">
            ...
            <form id="profileForm" method="POST" action="{{ route('finance.profile.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="commercial_register_number" name="commercial_register_number" value="{{ $financingCompany->commercial_register_number ?? '' }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $financingCompany->phone_number ?? '' }}" required>
                        @error('phone_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="upload-box d-flex flex-column align-items-center justify-content-center">
                            @if($financingCompany && $financingCompany->identity_image)
                                <img src="{{ asset($financingCompany->identity_image) }}" id="identityImagePreview" class="preview-img mb-2" width="100px" height="100px">
                            @else
                    ...
                    <div class="col-md-6">
                        <label class="upload-box d-flex flex-column align-items-center justify-content-center">
                            @if($financingCompany && $financingCompany->commercial_register_image)
                                <img src="{{ asset($financingCompany->commercial_register_image) }}" id="commercialImagePreview" class="preview-img mb-2" width="100px" height="100px">
                            @else
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <a href="{{ route('dashboard.finances') }}" class="btn btn-secondary ms-2">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
