...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="card p-4">
            ...
            <form id="profileForm" method="POST" action="{{ route('house.profile.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        <label class="form-label">اسم شركة السكن</label>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="commercial_register_number" name="commercial_register_number" value="{{ $housingCompany->commercial_register_number ?? '' }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $housingCompany->phone_number ?? '' }}" required>
                        @error('phone_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    {{-- <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3">{{ $housingCompany->address ?? '' }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div> --}}
                    <div class="col-md-6">
                        <label class="upload-box d-flex flex-column align-items-center justify-content-center">
                            @if($housingCompany && $housingCompany->identity_image)
                                <img src="{{ asset($housingCompany->identity_image) }}" id="identityImagePreview" class="preview-img mb-2" width="100px" height="100px">
                            @else
                    ...
                    <div class="col-md-6">
                        <label class="upload-box d-flex flex-column align-items-center justify-content-center">
                            @if($housingCompany && $housingCompany->commercial_register_image)
                                <img src="{{ asset($housingCompany->commercial_register_image) }}" id="commercialImagePreview" class="preview-img mb-2" width="100px" height="100px">
                            @else
                                <img src="{{ asset('build/assets/images/upload.png') }}" id="commercialImagePreview" class="preview-img mb-2" width="100px" height="100px">
                            @endif
                            <span class="fw-bold">صورة السجل التجاري</span>
                            <small class="text-muted">تحميل الملفات المحددة.</small>
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <a href="{{ route('dashboard.houses') }}" class="btn btn-secondary ms-2">إلغاء</a>
                </div>
            </form>
        </div>
    </div>
