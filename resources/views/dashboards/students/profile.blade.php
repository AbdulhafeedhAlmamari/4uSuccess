            ...
            <form id="profileForm" method="POST" action="{{ route('student.profile.update') }}"
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-auto">
                        <div class="profile-img">
                            @if ($user->profile_image)
                                <img src="{{ asset($user->profile_image) }}" id="profileImagePreview"
                                    alt="صورة الملف الشخصي">
                            @else
                                <img src="{{ asset('images/user-logo.svg') }}" id="profileImagePreview"
                                    alt="صورة الملف الشخصي">
                            @endif
                        </div>
                    </div>
                    <div class="col mt-4">
                        ...
                        <button type="button" class="btn btn-primary" onclick="$('#profileImageUpload').click()">تحميل صورة
                            جديدة</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="university_number" name="university_number"
                            value="{{ $student->university_number }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="university_name" name="university_name"
                            value="{{ $student->university_name }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone"
                            value="{{ $student->student_phone_number }}">
                        @error('phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-reset').click(function(e) {
                ...
                @else
                    $('#profileImagePreview').attr('src', '{{ asset('images/user-logo.svg') }}');
                @endif
