                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form action="" class="search-form">
                                ...
                                <div class="line"></div>
                                <select class="form-select form-select-sm  mx-2" aria-label="Default select example">
                                    <option selected>موقعك</option>
                                    <option value="1">الموقع 1</option>
                                    <option value="2">الموقع 2</option>
                                    <option value="3">الموقع 3</option>
                                </select>
                                <select class="form-select form-select-sm mx-2" aria-label="Default select example">
